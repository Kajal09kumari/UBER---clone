...
const ConfirmRide = (props) => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg relative">
      ...
      <h3 className="text-2xl font-bold text-gray-900 text-center mb-6">Confirm your Ride</h3>
      ...
      <div className="flex flex-col gap-4 items-center">
        ...
        <button
          ...
          className="w-full mt-6 bg-[#138808] text-white font-semibold py-3 rounded-lg hover:bg-green-700 transition-colors duration-200"
        >
          Confirm
        </button>
      </div>
...
export default ConfirmRide; // Explicitly export as default